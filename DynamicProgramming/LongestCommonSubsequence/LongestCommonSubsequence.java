...
public class LongestCommonSubsequence {
    ...
    private static void longestCommonSubsequence(String s1, String s2) {
        System.out.println("Naive Recursion Result=" + longestCommonSubsequenceRecursive(s1, s2, s1.length(), s2.length()));
        System.out.println("Memoization Result=" + longestCommonSubsequenceWithMemoization(s1, s2, s1.length(), s2.length(), initializeDP(s1.length(), s2.length())));
        System.out.println("Bottom Up Result=" + longestCommonSubsequenceBottomUp(s1, s2, s1.length(), s2.length()));
    }
